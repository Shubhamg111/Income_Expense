...
def addExpense(request):
    ...
    if request.method == "POST":
        ...
        Expenses.objects.create(owner = request.user,amount=amount,date=date,category=category,description=description)
...
def export_csv(request):
    ...
    writer.writerow(['Amount','Description','Expense Category','Date'])
...
def export_excel(request):
    ...
    columns = ['Amount','Description','Expense Category','Date']
